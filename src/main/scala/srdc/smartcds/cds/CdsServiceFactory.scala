...
import srdc.smartcds.cds.service.{DefinitionService, QRiskService, Score2Service, SmartRiskService, AdvanceService}
...
object CdsServiceFactory extends ICdsServiceFactory {
   ...
   */
  val servicesSupported: Set[String] = Set("qrisk", "definition", "score2", "smart", "advance")
